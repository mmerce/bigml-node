...
function storageReady(self, reqOptions, json) {
  return (typeof self.storage !== 'undefined' && self.storage !== null &&
    reqOptions.method !== "DELETE"  && reqOptions.store &&
    typeof reqOptions.resource !== 'undefined' &&
    typeof json.code !== 'undefined' && constants.HTTP_OK == json.code &&
    typeof json.status !== 'undefined' && json.status.code !== 'undefined' &&
    constants.FINAL_STATUS.indexOf(json.status.code) > -1);
}
  ...
  request(reqOptions, function (error, response, body) {
    ...
    if (body) {
      ...
      try {
        ...
        if (storageReady(self, reqOptions, json)) {
