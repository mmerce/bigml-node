...
// final status codes:
define("FINAL_STATUS", [constants.FINISHED, constants.FAULTY])
...
define("CLONABLE", ['source', 'dataset', 'model', 'ensemble',
  'cluster', 'anomaly', 'logisticregression', 'association',
  'topicmodel', 'timeseries', 'deepnet', 'pca', 'linearregression']);
